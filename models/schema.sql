...
VALUES   ("Joy", "Excited", "&#x1F601", "#ADFF2F", 101),
  ...
  ("Joy", "Helpful", "8#x1F91D", "#98FB98", 110),
  ("Joy", "Playful", "8#x1F61B", "#8AFFA5", 111),
  ("Joy", "Delighted", "8#x1F917", "#00A300", 112),
  ("Peace", "Calm", "8#x1F60C", "#4B0082", 201),
  ("Peace", "Fulfilled", "8#x1F64C", "#8B008B", 202),
  ("Peace", "Meditative", "8#x1F334", "#9932CC", 203),
  ("Peace", "Harmonious", "8#x262E", "#9400D3", 204),
