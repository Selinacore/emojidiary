...
VALUES   ("Joy", "Excited", "#ADFF2F", "&#x1F601", 101),
  ("Joy", "Sensuous", "#006400", "&#x1F60F", 102),
  ("Joy", "Energetic", "#228B22", "&#x1F92A", 103),
  ("Joy", "Cheerful", "#00FF00", "&#x263A", 104),
  ("Joy", "Creative", "#32CD32", "&#x1F58C", 105),
  ("Joy", "Hopeful", "#7CFC00", "&#x1F91E", 106),
  ("Joy", "Adventurous", "#6B8E23", "&#x1F343", 107),
  ("Joy", "Fascinated", "#5DBF40", "&#x1F9D0", 108),
  ("Joy", "Stimulated", "#17FF0F", "&#x1F61C", 109),
